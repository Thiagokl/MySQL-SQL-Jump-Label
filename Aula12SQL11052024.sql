...
CREATE OR REPLACE VIEW datas_promocoes AS
    ...
    SELECT * FROM datas_promocoes;    
      
      
	-- Crie uma view promocoes com a coluna titulo e cria uma coluna tipo_promocao verificando a coluna titulo. 
    -- Se na coluna titulo tiver a palavra Promoção então na nova coluna virá Promoção e caso na coluna titulo tenha a palavra Oferta 
    -- então na nova coluna virá Oferta. Caso contrário escreva Definir.
    -- Da tabela promocao_jumpflix
...
com o nome clientes_promo_top5. 
A segunda tabela terá a mesma estrutura; entretanto, será ordenada em ordem crescente, 
